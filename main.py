...
@app.route('/getAIPrediction', methods = ['POST'])
def getbw():
...
def getVal():
    ...
    subscription_key = '73d1b82332f64b739aa3cade8daeb9ef'
    ...
    response = requests.post(face_api_url, params=params, headers=headers, data = converted)
    faces = response.json()
    print(faces)
